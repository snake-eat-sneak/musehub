...
func init() {
	proto.RegisterType((*UserLoginRequest)(nil), "go.micro.srv.user.UserLoginRequest")
	proto.RegisterType((*UserLoginResponse)(nil), "go.micro.srv.user.UserLoginResponse")
}
...
var fileDescriptor_116e343673f7ffaf = []byte{
	...
	0xd7, 0x2b, 0x2e, 0x2a, 0xd3, 0x03, 0x49, 0x48, 0xf1, 0xe4, 0xe6, 0xa7, 0xa4, 0xe6, 0x14, 0x43,
	...
	0xb1, 0x81, 0x83, 0xc4, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xef, 0x92, 0xff, 0x69, 0x41, 0x01,
	0x00, 0x00,
}
